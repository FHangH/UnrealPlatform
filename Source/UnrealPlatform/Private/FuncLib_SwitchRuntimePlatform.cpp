#include "FuncLib_SwitchRuntimePlatform.h"

void UFuncLib_SwitchRuntimePlatform::SwitchRuntime(ERuntime& RUNTIME)
{
#if UE_EDITOR
...
void UFuncLib_SwitchRuntimePlatform::SwitchRuntime_Editor_Debug_Development_Shipping(ERuntime_Editor_Debug_Development_Shipping& RUNTIME)
{
#if UE_EDITOR
...
void UFuncLib_SwitchRuntimePlatform::SwitchPlatform(EPlatform& PLATFORM)
{
#if PLATFORM_WINDOWS
...
void UFuncLib_SwitchRuntimePlatform::SwitchPC_Linux(EPlatform_PC_Linux& PLATFORM)
{
#if PLATFORM_WINDOWS
...
void UFuncLib_SwitchRuntimePlatform::SwitchPC_Linux_Android(EPlatform_PC_Linux_Android& PLATFORM)
{
#if PLATFORM_WINDOWS
...
void UFuncLib_SwitchRuntimePlatform::SwitchPC_Linux_Android_IOS(EPlatform_PC_Linux_Android_IOS& PLATFORM)
{
#if PLATFORM_WINDOWS
